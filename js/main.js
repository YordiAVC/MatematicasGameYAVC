$(document).ready(function(){
   ...
   $('#contenedor').slideDown(300, function () {
    ...
    $('#nivel2').hide();
        ...
        $('#n2-0').hide();
        //opciones
            $('#opc_2_000').on('click', pulsarFalso);
            $('#opc_2_001').on('click', function () {
                sonidoCheck()
                $('#n2-0').slideUp(300, function () {
                    $('#n2-1').slideDown(1000);
                    niveles++;
                    muestra();
                })
            });
            $('#opc_2_002').on('click', pulsarFalso);
            $('#opc_2_003').on('click', pulsarFalso);
        $('#n2-1').hide();
        //opciones
            $('#opc_2_010').on('click', pulsarFalso);
            $('#opc_2_011').on('click', pulsarFalso);
            $('#opc_2_012').on('click', pulsarFalso);
            $('#opc_2_013').on('click', function () {
                sonidoCheck()
                $('#n2-1').slideUp(300, function () {
                    $('#n2-2').slideDown(1000);
                    niveles++;
                    muestra();
                })
        ...
        $('#n2-2').hide();
        //opciones
            $('#opc_2_020').on('click', pulsarFalso);
            $('#opc_2_021').on('click', pulsarFalso);
            $('#opc_2_022').on('click', function () {
                sonidoCheck()
                $('#n2-2').slideUp(300, function () {
                    $('#n2-3').slideDown(1000);
                    niveles++;
                    muestra();
                })
            });
            $('#opc_2_023').on('click', pulsarFalso);
        $('#n2-3').hide();
        //opciones
            $('#opc_2_030').on('click', pulsarFalso);
            $('#opc_2_031').on('click', function () {
                sonidoCheck()
                $('#n2-3').slideUp(300, function () {
                    $('#n2-4').slideDown(1000);
                    niveles++;
                    muestra();
                })
            });
            $('#opc_2_032').on('click', pulsarFalso);
            $('#opc_2_033').on('click', pulsarFalso);
        $('#n2-4').hide();
        //opciones
            $('#opc_2_040').on('click', pulsarFalso);
            $('#opc_2_041').on('click', pulsarFalso);
            $('#opc_2_042').on('click', function () {
                sonidoCheck()
                $('#n2-4').slideUp(300, function () {
                    $('#n2-5').slideDown(1000);
                    niveles++;
                    muestra();
                })
            });
            $('#opc_2_043').on('click', pulsarFalso);
        $('#n2-5').hide();
        //opciones
            $('#opc_2_050').on('click', function () {
                sonidoCheck()
                $('#n2-5').slideUp(300, function () {
                    $('#n2-6').slideDown(1000);
                    niveles++;
                    muestra();
                })
            });
            $('#opc_2_051').on('click', pulsarFalso);
            $('#opc_2_052').on('click', pulsarFalso);
            $('#opc_2_053').on('click', pulsarFalso);
        $('#n2-6').hide();
        //opciones
            $('#opc_2_060').on('click', pulsarFalso);
            $('#opc_2_061').on('click', pulsarFalso);
            $('#opc_2_062').on('click', pulsarFalso);
            $('#opc_2_063').on('click', function () {
                sonidoCheck()
                $('#n2-6').slideUp(300, function () {
                    $('#n2-7').slideDown(1000);
                    niveles++;
                    muestra();
                })
        ...
        $('#n2-7').hide();
        //opciones
            $('#opc_2_070').on('click', pulsarFalso);
            $('#opc_2_071').on('click', pulsarFalso);
            $('#opc_2_072').on('click', function () {
                sonidoCheck()
                $('#n2-7').slideUp(300, function () {
                    $('#n2-8').slideDown(1000);
                    niveles++;
                    muestra();
                })
            });
            $('#opc_2_073').on('click', pulsarFalso);
        $('#n2-8').hide();
        //opciones
            $('#opc_2_080').on('click', pulsarFalso);
            $('#opc_2_081').on('click', function () {
                sonidoCheck()
                $('#n2-8').slideUp(300, function () {
                    $('#n2-9').slideDown(1000);
                    niveles++;
                    muestra();
                })
            });
            $('#opc_2_082').on('click', pulsarFalso);
            $('#opc_2_083').on('click', pulsarFalso);
        $('#n2-9').hide();
        //opciones
            $('#opc_2_090').on('click', pulsarFalso);
            $('#opc_2_091').on('click', pulsarFalso);
            $('#opc_2_092').on('click', pulsarFalso);
            $('#opc_2_093').on('click', function () {
                sonidoSiguienteNivel();
                $('#n2-9').slideUp(300, function () {
                    $('#nivel3').fadeIn(2000);
                    niveles = 0;
                    nivel++;
                    muestra();
                    $('#nivel3').fadeOut(2000, function () {
                        $('#n3-0').slideDown(300);
                    });
                })
            });
    ...
    $('#nivel3').hide();
        ...
        //opciones
            $('#opc_3_000').on('click', function () {
                sonidoCheck()
                $('#n3-0').slideUp(300, function () {
                    $('#n3-1').slideDown(1000);
                    niveles++;
                    muestra();
                })
            });
            $('#opc_3_001').on('click', pulsarFalso);
            $('#opc_3_002').on('click', pulsarFalso);
            $('#opc_3_003').on('click', pulsarFalso);
        $('#n3-1').hide();
        //opciones
            $('#opc_3_010').on('click', pulsarFalso);
            $('#opc_3_011').on('click', pulsarFalso);
            $('#opc_3_012').on('click', function () {
                sonidoCheck()
                $('#n3-1').slideUp(300, function () {
                    $('#n3-2').slideDown(1000);
                    niveles++;
                    muestra();
                })
            });
            $('#opc_3_013').on('click', pulsarFalso);
        $('#n3-2').hide();
        //opciones
            $('#opc_3_020').on('click', pulsarFalso);
            $('#opc_3_021').on('click', pulsarFalso);
            $('#opc_3_022').on('click', pulsarFalso);
            $('#opc_3_023').on('click', function () {
                sonidoCheck()
                $('#n3-2').slideUp(300, function () {
                    $('#n3-3').slideDown(1000);
                    niveles++;
                    muestra();
                })
        ...
        $('#n3-3').hide();
        //opciones
            $('#opc_3_030').on('click', pulsarFalso);
            $('#opc_3_031').on('click', function () {
                sonidoCheck()
                $('#n3-3').slideUp(300, function () {
                    $('#n3-4').slideDown(1000);
                    niveles++;
                    muestra();
                })
            });
            $('#opc_3_032').on('click', pulsarFalso);
            $('#opc_3_033').on('click', pulsarFalso);
        $('#n3-4').hide();
        //opciones
            $('#opc_3_040').on('click', function () {sonidoCheck()
                $('#n3-4').slideUp(300, function () {
                    $('#n3-5').slideDown(1000);
                    niveles++;
                    muestra();
                })
            });
            $('#opc_3_041').on('click', pulsarFalso);
            $('#opc_3_042').on('click', pulsarFalso);
            $('#opc_3_043').on('click', pulsarFalso);
        $('#n3-5').hide();
        //opciones
            $('#opc_3_050').on('click', pulsarFalso);
            $('#opc_3_051').on('click', pulsarFalso);
            $('#opc_3_052').on('click', pulsarFalso);
            $('#opc_3_053').on('click', function () {
                sonidoCheck()
                $('#n3-5').slideUp(300, function () {
                    $('#n3-6').slideDown(1000);
                    niveles++;
                    muestra();
                })
        ...
        $('#n3-6').hide();
        //opciones
            $('#opc_3_060').on('click', pulsarFalso);
            $('#opc_3_061').on('click', function () {
                sonidoCheck()
                $('#n3-6').slideUp(300, function () {
                    $('#n3-7').slideDown(1000);
                    niveles++;
                    muestra();
                })
            });
            $('#opc_3_062').on('click', pulsarFalso);
            $('#opc_3_063').on('click', pulsarFalso);
        $('#n3-7').hide();
        //opciones
            $('#opc_3_070').on('click', pulsarFalso);
            $('#opc_3_071').on('click', function () {
                sonidoCheck()
                $('#n3-7').slideUp(300, function () {
                    $('#n3-8').slideDown(1000);
                    niveles++;
                    muestra();
                })
            });
            $('#opc_3_072').on('click', pulsarFalso);
            $('#opc_3_073').on('click', pulsarFalso);
        $('#n3-8').hide();
        //opciones
            $('#opc_3_080').on('click', pulsarFalso);
            $('#opc_3_081').on('click', function () {
                sonidoCheck()
                $('#n3-8').slideUp(300, function () {
                    $('#n3-9').slideDown(1000);
                    niveles++;
                    muestra();
                })
            });
            $('#opc_3_082').on('click', pulsarFalso);
            $('#opc_3_083').on('click', pulsarFalso);
        $('#n3-9').hide();
        //opciones
            $('#opc_3_090').on('click', function () { });
            $('#opc_3_091').on('click', pulsarFalso);
            $('#opc_3_092').on('click', pulsarFalso);
            $('#opc_3_093').on('click', pulsarFalso);
    //nivel4
    $('#nivel4').hide();
        //niveles del nivel4
        $('#n4-0').hide();
